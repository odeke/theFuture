...
[ExcludeClass]
internal class _My_AuctionsEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    private static var emptyArray:Array = new Array();

    model_internal static var allProperties:Array = new Array("status", "from_currency", "street", "bids", "auctions_id", "city", "amount", "expires", "bureaus_name", "officephone", "email", "premises", "cellphone", "min_rate", "bureaus_id", "to_currency");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("status", "from_currency", "street", "bids", "auctions_id", "city", "amount", "expires", "bureaus_name", "officephone", "email", "premises", "cellphone", "min_rate", "bureaus_id", "to_currency");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("status", "from_currency", "street", "bids", "auctions_id", "city", "amount", "expires", "bureaus_name", "officephone", "email", "premises", "cellphone", "min_rate", "bureaus_id", "to_currency");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("status", "from_currency", "street", "bids", "auctions_id", "city", "amount", "expires", "bureaus_name", "officephone", "email", "premises", "cellphone", "min_rate", "bureaus_id", "to_currency");
    model_internal static var sourceProperties:Array = emptyArray
    model_internal static var nonDerivedProperties:Array = new Array("status", "from_currency", "street", "bids", "auctions_id", "city", "amount", "expires", "bureaus_name", "officephone", "email", "premises", "cellphone", "min_rate", "bureaus_id", "to_currency");
    model_internal static var derivedProperties:Array = new Array();
    model_internal static var collectionProperties:Array = new Array();
    model_internal static var collectionBaseMap:Object;
    model_internal static var entityName:String = "My_Auctions";
    ...
    model_internal var _instance:_Super_My_Auctions;
    model_internal static var _nullStyle:com.adobe.fiber.styles.Style = new com.adobe.fiber.styles.Style();

    public function _My_AuctionsEntityMetadata(value : _Super_My_Auctions)
    {
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::nonDerivedProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity My_Auctions");
    ...
    override public function getCollectionBase(propertyName:String):String
    {
        if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity My_Auctions");
    ...
    override public function getPropertyType(propertyName:String):String
    {
        if (model_internal::allProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a property of My_Auctions");
    ...
    override public function getValue(propertyName:String):*
    {
        if (model_internal::allProperties.indexOf(propertyName) == -1)
        {
            throw new Error(propertyName + " does not exist for entity My_Auctions");
        }
    ...
    override public function setValue(propertyName:String, value:*):void
    {
        if (model_internal::nonDerivedProperties.indexOf(propertyName) == -1)
        {
            throw new Error(propertyName + " is not a modifiable property of entity My_Auctions");
        }
