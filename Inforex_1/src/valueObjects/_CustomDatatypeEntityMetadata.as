...
internal class _CustomDatatypeEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    ...
    model_internal static var allRequiredProperties:Array = new Array("bids_id", "status", "street", "from_currency", "bids_status", "auctions_id", "city", "amount", "expires", "bids_offer", "email", "officephone", "bureaus_name", "created", "premises", "cellphone", "bids_dated", "auctioner_id", "min_rate", "to_currency");
    ...
    public function _CustomDatatypeEntityMetadata(value : _Super_CustomDatatype)
    {
        ...
        model_internal::propertyTypeMap["bids_status"] = "int";
