 ...
 * of this value object you may modify the generated sub-class of this class - Auctions.as.
 */
...
[ExcludeClass]
public class _Super_Auctions extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    model_internal var _dminternal_model : _AuctionsEntityMetadata;
    ...
    private var _internal_order_id : int;
    ...
    public function _Super_Auctions()
    {
        _model = new _AuctionsEntityMetadata(this);
    ...
    [Bindable(event="propertyChange")]
    public function get order_id() : int
    {
    ...
    public function set order_id(value:int) : void
    {
        var oldValue:int = _internal_order_id;
        if (oldValue !== value)
        {
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _AuctionsEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _AuctionsEntityMetadata) : void
    {
        var oldValue : _AuctionsEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
